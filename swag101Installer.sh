...
# Remove the old launcher and file mover before installing the new one
...
pm install -s /mnt/external_sd/swagApps/com.morrison.applocklite-1.apk
pm install -s /mnt/external_sd/swagApps/com.morrison.processmanager.applock-1.apk
pm install -s /mnt/external_sd/swagApps/com.oncilla.LetterTracing-1.apk
pm install -s /mnt/external_sd/swagApps/com.sec.spp.push-1.apk
...
pm install -s /mnt/external_sd/swagApps/com.sevenacademy.thejoyofreadingfrom3yearsofage-1.apk
...
pm install -s /mnt/external_sd/swagApps/farfaria-fingerprint-whattime-v1.6.6-release.apk
...
# Kids Launcher and funfFileMover
...
# Remove the old BG Collector before pushing the new one
rm /system/app/funf_background_collector.apk
